...
| `dias_janela` | `5` | Janela rolante de emissão. Com ~95% marketplace, 14 dias truncava a listagem em 10 mil notas antes das compras reais |
...
2. Lista BLING `GET /nfe?tipo=0` com paginação (até 100 páginas) e janela de 5 dias. Se `nfes_lista_total` bater cravado em `compras_max_paginas × 100`, a listagem truncou — encurte `dias_janela` ou suba o teto de páginas.
